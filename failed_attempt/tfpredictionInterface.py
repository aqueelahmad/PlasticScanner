...
def getDataFromcsv():
    with open('test_data.csv') as csv_file:
            ...
            for row in csv_reader:
                measurements_upload = row
            
    #skip all firebase stuff and get data from csv file
    #print(measurements_upload)
    measurements = {"white": str(measurements_upload[0]),
...
def detectAndUpload():
    ...
    measurements = getDataFromcsv()
    recentScan = measurements
    wavelengths = []
